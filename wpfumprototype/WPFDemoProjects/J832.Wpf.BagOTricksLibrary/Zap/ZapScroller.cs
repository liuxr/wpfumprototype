...
namespace Microsoft.Samples.KMoore.WPFSamples.Zap
{
    public class ZapScroller : ItemsControl
    {
        ...
        private readonly ICommand _firstCommand, _previousCommand, _nextCommand, _lastCommand;
        private readonly Action m_canFirstChanged, m_canPreviousChanged, m_canNextChanged, m_canLastChanged;

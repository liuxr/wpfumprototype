...
namespace Microsoft.Samples.KMoore.WPFSamples.MineSweeper
{
    ...
    public class MineFieldElement : FrameworkElement, INotifyPropertyChanged
    {
        ...
        internal void NewGame()
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(MineField.StatePropertyName));
        }
        ...
        private void CreateElements()
        {
            ...
            //ControlTemplate template = FindResource(typeof(ContentControl)) as ControlTemplate;
            //DataTemplate dataTemplate = FindResource("SquareDataTemplate") as DataTemplate;
        ...
        private void _mineField_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            if (e.PropertyName == MineField.MinesLeftPropertyName)
            {
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs(MineField.MinesLeftPropertyName));
                }
            }
        ...
        private void timerTick(object state)
        {
            ...
            {
                __secondsElapsed++;
                PropertyChanged(this, new PropertyChangedEventArgs("SecondsElapsed"));
            }
        }

...
namespace Microsoft.Samples.KMoore.WPFSamples.Graph
{
    ...
    public class NodeCollection<TNode> where TNode : IEquatable<TNode>
    {
        ...
        public void Churn()
        {
            ...
            int itemIndex = m_random.Next(m_nodeConnections.Count);
            ...
            if (doAdd == true)
            {
                ...
                int indexToAdd = m_random.Next(m_nodeConnections.Count - m_nodeConnections[item].Count);
            ...
            else if (doAdd == false)
            {
                ...
                int indexToRemove = m_random.Next(m_nodeConnections[item].Count);
